...
public class BME68xTest {
	...
	public void validateData() {
		...
		int temp = 320;
		long res_heat_int = BME68x.calculateHeaterResistanceInt(calib, (int) ambient_temp, temp);
		Assertions.assertEquals(128, res_heat_int);
		float res_heat_float = BME68x.calculateHeaterResistanceFpu(calib, ambient_temp, temp);
